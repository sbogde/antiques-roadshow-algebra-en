...
\(ys \in \operatorname{Im} f \setminus \{0\}\). Hence
\[
  zrs = g(ys) \in \operatorname{Im}(g \circ f) \setminus \{0\},
\]
showing that \(\operatorname{Im}(g \circ f)\) is essential in \(P_R\).
(The converse implication will be established later.)
\end{proof}
